...
# Read in sites file=
data_PV <- read.csv("PV_Stars_Urchins2024-02-06.csv")
...
PV_sites_plot <- ggplot(california) +
  geom_sf(fill = "antiquewhite", linewidth = 0.3) +
  coord_sf(xlim = c(-118.25, -118.5), ylim = c(33.65, 33.82), crs = "+init=epsg:4326 +proj=longlat +ellps=WGS84 +datum=WGS84 +no_defs +towgs84=0,0,0", expand = F) +
...
PV_sites_plot
      ...
      # annotate regions  
    PV_map <- sites
    ggsave("PV sites.jpg", height = 5, width = 7, dpi = 300)
